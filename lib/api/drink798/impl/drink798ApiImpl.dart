...
import '../drink798Api.dart';

class Drink798ApiImpl extends Drink798API {
  Drink798ApiImpl._privateConstructor() {
    // 读取token
  ...
  static final Drink798ApiImpl _instance =
      Drink798ApiImpl._privateConstructor();

  factory Drink798ApiImpl() {
    return _instance;
  }
